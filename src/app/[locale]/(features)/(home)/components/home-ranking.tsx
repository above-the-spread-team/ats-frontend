    ...
    <div className="w-full">
      ...
      <div className="bg-card border border-border rounded-lg overflow-hidden shadow-sm">
        ...
        <div className="grid grid-cols-12 gap-2 px-3 py-2 bg-muted/50 border-b border-border text-xs font-semibold text-muted-foreground">
          <div className="col-span-1 text-center">{st("position")}</div>
          <div className="col-span-6">{st("team")}</div>
          <div className="col-span-2 text-center ">{st("played")}</div>
          <div className="col-span-3 text-right">{st("points")}</div>
        </div>
        {/* Standings List */}
