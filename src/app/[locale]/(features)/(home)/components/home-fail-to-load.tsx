  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 py-10 px-4 sm:px-6 text-center">
      ...
      <div className="space-y-1">
        <p className="text-sm font-semibold text-foreground">{message ?? t("failedToLoad")}</p>
        <p className="text-xs text-muted-foreground">{description ?? t("somethingWentWrong")}</p>
      </div>
    </div>
  );
}
