...
export default function Standings({ leagueId, season }: StandingsProps) {
  ...
  const tableColumns = useMemo(
    () => [
      { label: t("position"), align: "left" as const },
      { label: t("team"), align: "left" as const },
      { label: t("played"), align: "center" as const },
      { label: t("won"), align: "center" as const },
      { label: t("drawn"), align: "center" as const },
      { label: t("lost"), align: "center" as const },
      { label: t("goalsFor"), align: "center" as const },
      { label: t("goalsAgainst"), align: "center" as const },
      { label: t("goalDifference"), align: "center" as const },
      { label: t("points"), align: "center" as const },
      { label: t("form"), align: "center" as const },
    ],
    [t],
  );
