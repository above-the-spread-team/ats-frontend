  ...
  return (
    <div className="w-60 md:w-72 xl:w-80 2xl:w-96 h-full flex-shrink-0 flex flex-col px-2 pt-2 gap-3 bg-card/60 border-l border-border/60">
      <div className="px-1.5 pt-2 pb-1">
        <h3 className="text-base font-bold text-foreground">{t("matchThreads")}</h3>
      ...
      <div className="px-1.5">
        <div className="flex gap-1 bg-muted/40 rounded-xl p-1">
          {[
            { label: tc("tomorrow"), offset: -1 },
            { label: tc("today"), offset: 0 },
            { label: tc("yesterdayLabel"), offset: 1 },
          ].map((t) => {
        ...
        <div className="pt-1 pb-2">
          {isLoading ? (
            ...
            <div className="p-3 rounded-xl bg-destructive/10 border border-destructive/30">
              <p className="text-xs font-semibold text-destructive">{tc("failedToLoad")}</p>
